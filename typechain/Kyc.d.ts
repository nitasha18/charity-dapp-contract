...
interface KycInterface extends ethers.utils.Interface {
  functions: {
    ...
    "isKycLevel2(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "isKycLevel2", values: [string]): string;
...
export class Kyc extends Contract {
  ...
  isKycLevel2(_wallet: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  estimateGas: {
    ...
    isKycLevel2(_wallet: string, overrides?: CallOverrides): Promise<BigNumber>;
